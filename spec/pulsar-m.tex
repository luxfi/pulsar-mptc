...
Pulsar-M admits two protocol families that produce the same FIPS~204
output shape:
...
(\texttt{ref/go/pkg/pulsarm}, v0.2.0). Each party samples a 32-byte
...
unopened \texttt{cSHAKE256(c_i \| \mathit{blind}_i)} commit was
